 ...
 */
@Controller
public class  AuthenticationModuleManageController {
	
	protected final Log log = LogFactory.getLog(getClass());
	
	@RequestMapping(value = "/module/authentication/manage", method = RequestMethod.GET)
	public void manage(ModelMap model) throws Exception {
